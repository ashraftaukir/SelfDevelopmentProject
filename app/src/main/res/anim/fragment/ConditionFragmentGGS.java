...
public class ConditionFragmentGGS extends DialogFragment implements View.OnClickListener {
    ...
    public ConditionFragmentGGS() {
        // Required empty public constructor
    }


    public static com.gagagugu.ggservice.fragment.ConditionFragmentGGS newInstance() {
        com.gagagugu.ggservice.fragment.ConditionFragmentGGS fragment = new com.gagagugu.ggservice.fragment.ConditionFragmentGGS();
    ...
    private void initializeList(Bundle bundle) {
        ...
        // Log.d("conditionlist",new Gson().toJson(conditionlist));

      //  Toast.makeText(getContext(),String.valueOf(UtilsGGS.getGgProduct(getContext()).getCondition().getId()),Toast.LENGTH_SHORT).show();
